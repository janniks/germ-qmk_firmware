...
[SYMB] = LAYOUT_gergoplex(
  ...
  KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_SPC,    KC_PLUS, KC_MINS, KC_SLSH, KC_ASTR, KC_QUOT,
  KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_SPC,    KC_AMPR, KC_EQL,  KC_COMM, KC_DOT,  KC_MINS,
                    CMB_TOG, KC_SCLN, KC_EQL,     KC_EQL,  KC_SCLN, KC_DEL
),
/* Keymap 2: Numbers layer */
[NUMB] = LAYOUT_gergoplex(
  KC_1,  KC_2,  KC_3,  KC_4,  KC_5,         KC_6,    KC_7,    KC_8,     KC_9,    KC_0,
  KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,        KC_SPC, KC_SPC, KC_SPC,   KC_SPC, KC_VOLU,
  KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,       KC_SPC, KC_SPC, KC_SPC, KC_SPC, KC_VOLD,
